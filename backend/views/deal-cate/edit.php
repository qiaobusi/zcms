  ...
  <div class="content-wrapper">
    ...
    <section class="content">
    	<div class="row">
            ...
            <form class="form-horizontal" id="form" action="<?php echo Url::to(['deal-cate/save']); ?>">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="DealCate[name]" placeholder="借款分类" value="<?php echo $dealCate->name; ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  	<select id="is_effect" class="form-control" name="DealCate[is_effect]">
	                    <option value="0" <?php if ($dealCate->is_effect == 0): ?>selected="selected"<?php endif; ?>>否</option>
	                    <option value="1" <?php if ($dealCate->is_effect == 1): ?>selected="selected"<?php endif; ?>>是</option>
	                </select>
                    <span class="help-block" style="color:#f00;"></span>
                  </div>
                </div>
