                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  	<select id="is_effect" class="form-control" name="DealType[is_effect]">
	                    <option value="0" <?php if ($dealType->is_effect == 0): ?>selected="selected"<?php endif; ?>>否</option>
	                    <option value="1" <?php if ($dealType->is_effect == 1): ?>selected="selected"<?php endif; ?>>是</option>
	                </select>
                    <span class="help-block" style="color:#f00;"></span>
                  </div>
                </div>
