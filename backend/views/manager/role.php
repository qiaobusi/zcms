    ...
    <section class="content">
      ...
      <div class="col-sm-12">
        <div class="box box-default">
              ...
              <h3 class="box-title">管理员 [<?php echo $manager->username; ?>]</h3>
              <div class="box-tools">
              </div>
            </div>
            <!-- /.box-header -->
            <form class="form-horizontal" id="form" action="<?php echo Url::to(["manager/save-role"]); ?>">
            	<input name="_csrf-backend" type="hidden" id="_csrf" value="<?php echo Yii::$app->request->csrfToken; ?>">
            	<input name="manager_id" type="hidden" id="manager_id" value="<?php echo $manager->id; ?>">
            <div class="box-body no-padding">
              <table class="table table-bordered table-striped">
                ...
                <tr>
                  <td><input <?php if (in_array($role->id, $manager_roles)): ?>checked="checked"<?php endif;?> class="checkOne" name="role_id[]" type="checkbox" value="<?php echo $role->id; ?>"></td>
