...
?>
              ...
              <table class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td style="width: 150px; text-align:right;">
                  	...
                  	<button type="button" class="btn btn-sm btn-danger" onclick="del(<?php echo $dealAgency->id; ?>)">删除</button>
                  </td>
                </tr>
                <?php endforeach; ?>
              </table>
  ...
  <script type="text/javascript">
		...
		function add() {
				window.location.href = "<?php echo Url::to(['deal-agency/add']); ?>";
		}
		...
		function del(id) {
				delId = id;
				showConfirm('删除', '确认删除？', deleteDealAgency);
		}
		
		function deleteDealAgency() {
				$.ajax({
						url: '<?php echo Url::to(['deal-agency/del']); ?>',
						type: 'GET',
						data: {
								'id': delId,
						},
