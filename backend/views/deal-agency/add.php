  ...
  <div class="content-wrapper">
    ...
    <section class="content">
    	<div class="row">
            ...
            <form class="form-horizontal" id="form" action="<?php echo Url::to(['deal-agency/insert']); ?>">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="DealAgency[name]" placeholder="担保机构">
